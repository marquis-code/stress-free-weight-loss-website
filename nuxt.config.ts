...
//   nitro: {
//     prerender: {
//       routes: ['/', '/landing'], // Only include fully static routes
//       exclude: ['/payment', '/questionaire'], // Exclude dynamic routes
//     },
//   },
//   runtimeConfig: {
//     public: {
//       apiBase: process.env.API_BASE || 'https://default-api-url.com',
//     },
//   },
