 ...
 <main>
	<div class="h-screen w-full flex overflow-hidden select-none">
		...
		<main
			...
			<div class="lg:flex">
				<div
					class="lg:mr-6 lg:w-1/2 mt-8 py-2 flex-shrink-0 flex flex-col bg-white
...
<li class="mt-2">
	<a
		...
		<p
			...
			text-gray-600 my-3">
			<!-- Middle section -->
			Drinking enough water helps to boost your metabolism, cleanse your body of waste, and acts as an appetite suppressant. Aim for at least 8 glasses a day.
		</p>
...
<li class="mt-2">
	<a
		...
		<p
			...
			text-gray-600 my-3">
			<!-- Middle section -->
			Incorporating physical activity into your daily routine can help burn calories, strengthen muscles, and improve overall well-being. Even 30 minutes a day can make a difference.
		</p>
