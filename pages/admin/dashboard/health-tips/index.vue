<template>
  ...
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold text-gray-900">Health Tips</h1>
      <p class="mt-2 text-sm text-gray-700">A list of all health tips</p>
    </div>
  ...
  <div  v-if="!loading && healthTips?.length" class="-mx-4 mt-10 ring-1 ring-gray-100 sm:mx-0 sm:rounded-lg">
    <table class="min-w-full divide-y divide-gray-100">
      ...
      <tbody class="bg-white">
        <tr v-for="(item, idx) in healthTips" class="even:bg-gray-50">
