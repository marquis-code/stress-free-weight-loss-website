...
const cardNumber = ref('4256 4256 4256 4256');
const cardHolder = ref('John Doe');
const expDate = ref('12/24');
const ccv = ref('342');
      ...
      <div class="w-full lg:w-1/2 lg:pr-8 lg:border-r-2 lg:border-slate-300">
        <div class="mb-4">
          ...
          <input
            ...
            class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            maxlength="19"
        ...
        <div class="flex gap-x-2 mb-4">
          <div class="block">
            ...
            <input
              ...
              v-model="expDate"
              @focus="hideBackCard"
              @input="expDate = formatExpDate(expDate)"
              class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              maxlength="5"
              placeholder="MM/YY"
            />
            ...
            >
              ...
              <div class="w-full px-8 absolute top-8">
                <div class="pt-1">
                  ...
                  <p class="font-medium tracking-more-wider h-6">{{ cardNumber }}</p>
                </div>
                <div class="pt-6 flex justify-between">
                  <div>
                    <p class="font-light">Name</p>
                    <p class="font-medium tracking-widest h-6">{{ cardHolder }}</p>
                  </div>
                  <div>
                    <p class="font-light">Expiry</p>
                    <p class="font-medium tracking-wider h-6 w-14">{{ expDate }}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="w-full absolute top-8">
                ...
                <div class="px-8 mt-5">
                  <div class="flex space-between">
                    ...
                    <p class="bg-white text-black flex items-center pl-4 pr-2 w-14">{{ ccv }}</p>
                  </div>
