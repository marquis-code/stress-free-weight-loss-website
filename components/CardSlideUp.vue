<template>
<main class="grid lg:grid-cols-2 gap-6 pb-20 w-full">
  ...
  <div class="absolute bg-gradient-to-t from-black w-full h-full transform duration-500 inset-y-3/4 group-hover:-inset-y-0">
    ...
    <div class="flex justify-center items-center">
        <a href="#contact-form" class="absolute text-center  py-3 bottom-6 bg-white text-black font-bold rounded-lg h-10 w-48">Contact Us</a>
    </div>
  </div>
</div>
...
<div class="relative group w-full h-96 overflow-hidden bg-black m-auto rounded-xl">
  ...
  <div class="absolute bg-gradient-to-t from-black w-full h-full transform duration-500 inset-y-3/4 group-hover:-inset-y-0">
    ...
    <div class="flex justify-center items-center">
        <a href="#contact-form" class="absolute text-center  py-3 bottom-6 bg-white text-black font-bold rounded-lg h-10 w-48">Contact Us</a>
        <!-- <button class="absolute  py-3 bottom-6 bg-white text-black font-bold rounded-lg h-10 w-48">Contact Us</button> -->
    </div>
  </div>
</div>
